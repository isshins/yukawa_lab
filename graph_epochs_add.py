...
def conmprison_epochs():
    ...
    for i in range(4):
        ...
        plt.plot(epochs, myopinion2[i], '#e41a1c', label='myopinion2')
        plt.plot(epochs, myopinion3[i], '#377eb8', label='myopinion3')
        plt.plot(epochs, myopinion4[i], '#ffff33', label='myopinion4')
