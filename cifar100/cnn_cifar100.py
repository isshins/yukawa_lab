...
activations = ["relu","sigmoid", "Swish", "Tanexp", "Tanexp0411"]
...
def tanexp0411(inputs):
    return inputs * tf.math.tanh(tf.math.exp(inputs * 1.1 + 0.4))
...
# mnistのデータ変換
(x_train_val, y_train_val), (x_test, y_test) = cifar100.load_data(label_mode='fine')
...
for act in activations:
    ...
    np.savetxt(f'./cnn/{dataset}_{act}.csv', [loss, acc, val_loss, val_acc])
