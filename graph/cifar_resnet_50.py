...
def conmprison_cifar():
    relu = np.loadtxt('cifar/resnet/cifar10_relu_50.csv')
    selu = np.loadtxt('cifar/resnet/cifar10_selu_50.csv')
    swish = np.loadtxt('cifar/resnet/cifar10_Swish_50.csv')
    mish = np.loadtxt('cifar/resnet/cifar10_Mish_50.csv')
    tanexp = np.loadtxt('cifar/resnet/cifar10_Tanexp_50.csv')
    softplus = np.loadtxt('cifar/resnet/cifar10_softplus_50.csv')
    elu = np.loadtxt('cifar/resnet/cifar10_elu_50.csv')
    myopinion = np.loadtxt('cifar/resnet/cifar10_Myopinion_50.csv')
